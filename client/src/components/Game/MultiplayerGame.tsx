...
export const MultiplayerGame: React.FC = () => {
  ...
  const [raceResults, setRaceResults] = useState<{ totalTime: number; fastestLap: number } | null>(null);
        ...
        <div className="game-results">
          <div className="results-content">
            ...
            <div className="result-item">
              ...
              <span className="value">{formatTime(raceResults.fastestLap)}</span>
            </div>
            <button onClick={handleLeave} className="btn-primary">
              Back to Lobby
            </button>
      ...
      {!loading && !error && !raceResults && (
        <div className="game-hud">
          <div className="hud-item">
            ...
            <span className="hud-value">{currentLap}/{maxLaps}</span>
          </div>
          <div className="hud-item">
